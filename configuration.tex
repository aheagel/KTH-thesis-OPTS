...
\hypersetup{
    colorlinks=true,
    linkcolor=black,     % Internal section/figure/table links
    citecolor=black,     % Citation numbers pointing to bibliography
    urlcolor=blue        % Live external website URLs
}


% Add this command to prevent vertical stretching 
\raggedbottom
...
\titleformat{\chapter}[hang]{\normalfont\fontsize{24}{28}\selectfont\bfseries\fontspec{Figtree-Medium}\raggedright}{\hspace*{-1cm}\thechapter}{20pt}{}
